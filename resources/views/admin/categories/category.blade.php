                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm flex items-center">
                                    <button
                                        ...
                                        onclick="showForm('{{ $category->id }}', {'name' : '{{ $category->name }}'},'Sửa phân loại', 'Sửa', '{{ url()->current() . '/edit' }}')"
                                        aria-label="Edit">
                                    ...
                                    <button
                                        ...
                                        onclick="openModal('{{ url()->current() . '/delete?id=' . $category->id }}', 'Xóa phân loại', '{{ $category->name }}')">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
