    ...
    <div class="w-full rounded-lg z-50 max-w-md h-screen">
        <div class="bg-white rounded-lg p-8">
            ...
            <form id="url-form" method="POST" action="" enctype="multipart/form-data">
                ...
                <img id="image-preview" class="w-96 h-48 border-4 border-white">
                <input type="file" id="image" class="h-10 mt-1 rounded w-full bg-gray-50"
                    name="image" onchange="previewImage(this)" required>
                <input type="text" name="url" id="url"
                    class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                    title="Vui lòng nhập đúng liên kết. VD: http://da.test/food" 
